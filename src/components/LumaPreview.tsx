...
export default function LumaPreview() {
  return (
    <ProjectPreviewSection
      title="Mobile Triage"
      description={`Stay updated on production health from anywhere. Luma's mobile interface notifies you of critical issues and allows for instant AI-assisted root cause analysis on the go.`}
      bgColor="#fafafc"
    >
      <IPhoneDisplay height="800px">
